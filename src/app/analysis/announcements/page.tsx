  ...
  return (
    <div className="min-h-screen bg-metallic-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Company Search Header - shows when searching a specific ticker */}
        {searchedCompany && (
          <div className="flex items-center justify-between mb-6 p-4 bg-primary-500/10 border border-primary-500/30 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-metallic-100">{searchedCompany} Announcements</h3>
          ...
          {loading || searchingCompany ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-metallic-400">
                {searchingCompany ? `Searching ${searchedCompany} announcements...` : `Loading announcements from ${selectedExchange}...`}
              </p>
            </div>
          ) : searchedCompany ? (
            ...
            companyAnnouncements.length > 0 ? (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <h4 className="font-medium text-metallic-100 mb-2">{ann.title}</h4>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-metallic-100 mb-2">No announcements found for {searchedCompany}</h3>
                <p className="text-metallic-400">Try extending the date range or check the ticker symbol</p>
              </div>
            )
          ) : (
            // Show general feed announcements
        ...
        {!loading && !searchingCompany && !searchedCompany && filteredAnnouncements.length === 0 && (
          <div className="text-center py-12">
            <FileText className="w-12 h-12 text-metallic-600 mx-auto mb-4" />
        ...
        {/* Load More */}
        {((searchedCompany && companyAnnouncements.length > 0) || (!searchedCompany && filteredAnnouncements.length > 0)) && (
          <div className="text-center mt-8">
            {searchedCompany ? (
              ...
              >
                View Full {searchedCompany} Profile
