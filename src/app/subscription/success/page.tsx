...
export default function SubscriptionSuccessPage() {
  ...
  useEffect(() => {
    ...
    // For now, we just show success if we have a session_id
    if (sessionId) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold text-gray-900">
          Welcome to InvestOre Pro!
        </h1>
        <p className="mt-2 max-w-md text-gray-600">
          Your subscription is now active. You have access to all Professional
          features including advanced analytics, exports, and API access.
        </p>
